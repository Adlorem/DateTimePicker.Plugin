...
using Xamarin.Plugin.DateTimePicker.iOS;

[assembly: ExportRenderer(typeof(PickerView), typeof(PickerViewRenderer))]
namespace Xamarin.Plugin.DateTimePicker.iOS
{
    internal class PickerViewRenderer : ViewRenderer<PickerView, UIPickerView>
    {
